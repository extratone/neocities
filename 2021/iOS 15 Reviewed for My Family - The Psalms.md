...
> It's been a tough summer for the Always Feature-Focused Tribe.      Eighty days ago, Apple's Senior Vice President of Software Engineer...
...
Above is a screenshot of my first test contribution to Apple Maps (my [mom’s private practice](http://bit.ly/elonglcswam),) which also serves as an example of Maps’ new “place cards.” As of this writing, all of my test contributions are still held “Pending Review,” yet navigating to [the share link](https://maps.apple.com/place?_ext=CjIKBQgEEOIBCgQIBRADCgQIBhByCgQIChAACgQIUhAECgQIVRAACgQIWRAGCgUIpAEQARImKZSjW%2Fv4dkNAMW0PujQxGVfAORJ5gVcfeENAQd9%2FR%2F9zGFfAUAM%3D&address=1714+Oak+Cliff+Pl%2C+Columbia%2C+MO++65203%2C+United+States&auid=6487223830929868055&ll=38.933965%2C-92.387854&lsp=9902&q=Eileen+Long%2C+MSW+LCSW&t=m) with a desktop browser indicates they've already been made public.
...
-   **Tab Groups** will almost certainly be nothing but a nuisance for all but the most ridiculous iPhone poweruses like myself.[3](https://bilge.world/ios-15-family-review#fnref3)
...
Finally, the great, terrible Apple God has granted its bizarre animated minimes a torso! I have always found memoji [alarming](https://www.reddit.com/r/iphone/comments/he03xb), mostly, but now that I’ve paid them mind, I would like to express my sympathy for those of you who enjoy using them. I’m sorry to report that you will still need to go to `Messages` and open the compose window in a conversation in order to select the emoji iMessage app. Though iOS 15 adds full bodies to memoji (and clothes to cover them, as required since Adam & Eve,) as well as “accessible accessories,”[4](https://bilge.world/ios-15-family-review#fnref4) there’s not as yet any way to actually *see* a memoji in full-body view other than the editing interface (as far as I could tell.) You can also choose to separately color your memoji’s eyes.
...
[1](https://bilge.world/ios-15-family-review#fn1) If you’re reading this and happen to be looking for app recommendations, let me know and I’ll ask her. [2](https://bilge.world/ios-15-family-review#fn2) This wasn’t working reliably in the last Developer Beta, but I’ll do my best to check back for the normal release. [3](https://bilge.world/ios-15-family-review#fn3) This is one of those things I can’t say more about until I actually hear from other folks… I’ll check back in a month or so. [4](https://bilge.world/ios-15-family-review#fn4) The full quote: “Three new accessibility options let you represent yourself with cochlear implants, oxygen tubes, or a soft helmet.”

[#software](https://bilge.world/tag:software)

![](https://i.snap.as/a8Zz1GxC.jpeg)
***
